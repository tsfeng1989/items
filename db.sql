...
insert into tb_Vip_users values(my_seq.nextval,'ÈıĞÇs7',6999,sysdate,0);
insert into tb_Vip_users values(my_seq.nextval,'÷ÈÀ¶5s',999,sysdate,0);
insert into tb_Vip_users values(my_seq.nextval,'»ªÎªp9',5999,sysdate,0);
